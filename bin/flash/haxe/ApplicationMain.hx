...
class ApplicationMain {
	...
	public static function main() {
		...
		//nme.Lib.setPackage("Jaroslav Meloun - jarnik - www.jarnik.com", "ld28", "ld28", "1.0.0");
	...
	private static function begin() {
		...
		for (methodName in Type.getClassFields(jarnik.ld28.Main))
		{
			if (methodName == "main")
			{
				hasMain = true;
		...
		if (hasMain)
		{
			Reflect.callMethod(jarnik.ld28.Main, Reflect.field (jarnik.ld28.Main, "main"), []);
		}
		else
		{
...
class DocumentClass extends jarnik.ld28.Main { }
